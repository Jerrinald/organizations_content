...
final class OrganizationVoter extends Voter
{
    ...
    public const string PUBLISH_ARTICLES = 'ORG_PUBLISH_ARTICLES';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        return $subject instanceof Organization
            && \in_array($attribute, [self::VIEW, self::EDIT, self::DELETE, self::MANAGE_MEMBERS, self::MANAGE_BILLING, self::EXPORT, self::PUBLISH_ARTICLES], true);
    }
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token, ?Vote $vote = null): bool
    {
        ...
        $subscription = $this->subscriptionRepository->findOneBy(['organization' => $subject]);
        $role = $member->getRole();
        ...
        return match ($attribute) {
            ...
            self::PUBLISH_ARTICLES => $role->canPublish(),
            default => false,
        };
    }
}
